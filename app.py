...
def main():
    ...
    print("1. SQL Injection" + (" ✓" if sql_injection_loaded else " (failed to load)"))
    print("2. Command Injection" + (" ✓" if command_injection_loaded else " (failed to load)"))
    ...
    print("5. Path Traversal" + (" ✓" if path_traversal_loaded else " (failed to load)"))
